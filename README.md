...
| `logo.png` | Cabinet Odyssey logo (transparent) | 512×512px, PNG with alpha |
...
- `index.html` — All-in-one page with Tailwind CSS + GSAP animations
...
- Google Fonts (Playfair Display, Inter, Noto Serif TC)
